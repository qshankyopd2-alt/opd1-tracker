...
class RiotClient:
    ...
    def party_state(self, region: str | None = None) -> dict:
        ...
        try:
            ...
            return {"available": False, "message": "An unexpected error occurred while fetching party state."}
    ...
    def set_queue(self, queue_id: str, dry_run: bool = True,
        ...
        try:
            ...
            return {"ok": False, "message": "Change gamemode failed."}
    ...
    def start_queue(self, dry_run: bool = True, region: str | None = None) -> dict:
        ...
        try:
            ...
            return {"ok": False, "message": "Start queue failed."}
    ...
    def stop_queue(self, dry_run: bool = True, region: str | None = None) -> dict:
        ...
        try:
            ...
            return {"ok": False, "message": "Cancel queue failed."}
