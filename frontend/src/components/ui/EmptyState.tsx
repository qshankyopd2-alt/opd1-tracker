...
export function EmptyState({
  ...
  return (
    <div data-testid={testId} className="flex flex-col items-center justify-center py-16 px-6 text-center rise">
      ...
      <h3 className="font-display font-700 text-lg uppercase tracking-wide text-zinc-200 font-bold">{title}</h3>
      {message && <p className="text-zinc-500 mt-1.5 max-w-md text-[13px] leading-relaxed">{message}</p>}
