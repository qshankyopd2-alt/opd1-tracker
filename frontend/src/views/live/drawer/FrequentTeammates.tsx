    ...
    <div className={embedded ? "" : "mt-3"} data-testid="drawer-frequent-teammates">
      ...
      <ul className="divide-y divide-edge">
        {teammates.map((teammate) => (
          <li key={teammate.puuid} className="min-w-0 px-1 py-3">
            <div className="flex min-w-0 items-baseline gap-2">
              <span className="min-w-0 flex-1 text-[15px] font-semibold text-zinc-100"><PlayerIdentity name={teammateName(teammate)} /></span>
